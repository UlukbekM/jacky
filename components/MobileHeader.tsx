...
export default function MobileHeader() {
    ...
    return (
        <div className="my-auto">
            ...
            <div className={`fixed top-0 left-0 z-10 h-screen w-screen transform opacity-95 duration-300 ease-in-out bg-zinc-200 dark:bg-zinc-900 translate-x-0 ${
                sideNav ? 'translate-x-0' : 'translate-x-full'}`} > 
                <div className="flex justify-end">
                    <button className="pt-6 pr-6" onClick={onToggleNav}><AlignJustify /></button>
                </div>
